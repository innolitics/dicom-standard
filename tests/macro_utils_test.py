...
def test_insert_nested_macro():
    mock_table = {
        ...
        'name': 'mock-table',
        'attributes': [
            {'name': '<td>Attribute 1</td>', 'type': 'None', 'tag': '00010001', 'description': 'something' },
            {'name': '<td>&gt;Include <a href="#somemacro" class="xref">Table Otherthing</a></td>', 'type': 'None', 'tag': 'None', 'description': 'None' }
        ]
    }
    ...
    mock_macros = {
        "somemacro": {
            ...
            'name': 'mock-macro',
            'attributes': [
                {'name': '<td>Attribute 1a</td>', 'type': 'None', 'tag': '00010002', 'description': 'some attribute in a macro'},
                {'name': '<td>&gt;Attribute 1e</td>', 'type': 'None', 'tag': '00010005', 'description': 'some nested attribute in a macro'},
                {'name': '<td>&gt;&gt;Include <a href="#somemacro2" class="xref">Table Otherthing2</a></td>', 'type': 'None', 'tag': 'None', 'description': 'None' }
            ]
        },
        "somemacro2": {
            ...
            'name': 'mock-macro-2',
            'attributes': [
                {'name': '<td>Attribute 1b</td>', 'type': 'None', 'tag': '00010003', 'description': 'some other attribute in a macro'},
                {'name': '<td>&gt;Attribute 1c</td>', 'type': 'None', 'tag': '00010004', 'description': 'some final attribute in a macro'}
            ]
        }
    }
